...
- ### 3 Ways Spark went against Conventional Wisdom:
  - **Adding SQL on top of Spark** (i.e., a competitor to Big Data processing frameworks at the time) gave the ability for in-memory, low-latency, general graphs of MapReduce operations, essentially giving the best of both worlds (i.e., Conventional DBs and MPPs). It also gave mid-query fault tolerance which could tolerate changes (to a degree) in the cluster's hardware. 
