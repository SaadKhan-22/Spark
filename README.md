...
- ### 3 Ways Spark went against Conventional Wisdom:
  ...
  - Using a **High-level implementation language** such as Scala was against the trend of using C or Java. This worked because the bottleneck back then was in I/O and not CPU. 
